...
OUTPUT_DIR="/path/to/output/qwen25vl_vid_vqa"
MODEL_NAME="Qwen/Qwen2.5-VL-7B-Instruct"

# You can choose fps OR nframes (comment one)
FPS=2.0
# NFRAMES=64

TOTAL_PIXELS=$((20480*28*28))  # 16056320
MIN_PIXELS=$((16*28*28))       # 12544
# MAX_PIXELS=$((768*28*28))    # 602112 (optional)
...
NUM_SAMPLES= # leave empty to use all
DTYPE="bfloat16"
FLASH_ATTN2=0
DEVICE_MAP="auto"
